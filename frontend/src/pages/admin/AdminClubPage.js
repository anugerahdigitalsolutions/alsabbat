  ...
  return (
    <ResourceManager
      ...
      fields={[
        ...
        { name: 'founded_date', label: 'Tanggal Berdiri', type: 'date' },        { name: 'location', label: 'Lokasi', type: 'text' },
        { name: 'stadium', label: 'Stadion', type: 'text', help: 'Nama stadion / lapangan resmi klub.' },
        {
          name: 'historical_played',
          label: 'Main (Historis)',
          type: 'number',
          help: 'Nilai awal statistik sejarah klub. Total = nilai ini + pertandingan baru yang sudah selesai.',
        },
        { name: 'historical_wins', label: 'Menang (Historis)', type: 'number' },
        { name: 'historical_draws', label: 'Seri (Historis)', type: 'number' },
        { name: 'historical_losses', label: 'Kalah (Historis)', type: 'number' },
