...
export const TERMS = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        'Pengguna dapat meminta penghapusan akun melalui fitur "Hapus Akun" di dalam aplikasi (Profile → Pengaturan Akun → Hapus Akun) atau melalui halaman resmi https://alsabbat.com/hapus-akun.',
    ...
    },
    {
      title: '14. Kontak',
      body: [
        'Untuk pertanyaan mengenai layanan, akun, privasi, atau penghapusan data, pengguna dapat menghubungi kontak resmi AL SABBAT yang tersedia pada aplikasi (menu Info Klub) dan website resmi.',
      ],
    },
  ],
};
...
export const PRIVACY = {
  ...
  intro:
    'Kebijakan ini menjelaskan data pengguna yang diproses aplikasi AL SABBAT, tujuan pemrosesannya, ' +
    'serta cara pengguna menghapus akun dan data pribadinya.',
  sections: [
    {
      title: '1. Data yang Diproses',
      body: ['AL SABBAT hanya memproses data yang diperlukan untuk menjalankan fitur aplikasi:'],
      bullets: [
    ...
    },
    {
      ...
      body: [
        'AL SABBAT tidak menjual data pengguna. Data hanya diproses oleh pengurus klub yang berwenang serta penyedia layanan teknis yang dipakai aplikasi (penyimpanan media, layanan email, dan layanan pengiriman notifikasi).',
      ],
    },
    {
      title: '4. Penghapusan Akun',
      body: [
        'Anda dapat menghapus akun kapan saja langsung dari aplikasi: Profile → Pengaturan Akun → Hapus Akun. Permintaan yang sama juga dapat dilakukan tanpa aplikasi melalui https://alsabbat.com/hapus-akun.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'foto yang Anda unggah melalui aplikasi, kecuali foto yang masih dipakai pada profil Pemain/Staf resmi klub.',
      ],
    },
    {
      title: '6. Data yang Dipertahankan',
      body: [
        'Profil Pemain/Staf yang sudah disetujui merupakan data roster resmi klub yang dikelola pengurus, sehingga tetap dipertahankan; tautan ke akun Anda dihapus.',
    ...
    },
    {
      title: '8. Kontak',
      body: [
        'Pertanyaan mengenai privasi atau penghapusan data dapat disampaikan melalui kontak resmi AL SABBAT yang tersedia pada aplikasi (menu Info Klub) dan website resmi.',
      ],
    },
  ],
};
...
/** Ringkasan yang ditampilkan pada layar konfirmasi Hapus Akun (sesuai backend). */
export const DELETION_REMOVED = [
  'Akun AL SABBAT Anda: nama, email, nomor WhatsApp, kata sandi, nomor & kode member.',
  'Semua sesi login — token yang tersimpan langsung tidak berlaku.',
  'Kode OTP dan token reset kata sandi milik akun.',
  'Token notifikasi semua perangkat Anda.',
  'Notifikasi pribadi Anda di dalam aplikasi.',
  'Pengajuan Pemain/Staf milik Anda beserta data pribadi di dalamnya.',
  'Foto yang Anda unggah melalui aplikasi (kecuali yang masih dipakai profil Pemain/Staf resmi klub).',
];

export const DELETION_RETAINED = [
  'Profil Pemain/Staf yang sudah disetujui tetap menjadi data roster resmi klub; tautan ke akun Anda dihapus.',
